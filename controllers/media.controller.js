...
export const createMedia = async (req, res) => {
  try {
    const { title, type, category, thumbnailUrl, fileUrl, description, featured } = req.body;
    const media = await Media.create({ title, type, category, thumbnailUrl, fileUrl, description, featured });
